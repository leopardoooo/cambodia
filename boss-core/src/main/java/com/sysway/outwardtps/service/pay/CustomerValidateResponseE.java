/**
 * CustomerValidateResponseE.java
 *
...
/**
 *  CustomerValidateResponseE bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CustomerValidateResponseE implements org.apache.axis2.databinding.ADBBean {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localCustomerNameTracker) {
            elementList.add(new javax.xml.namespace.QName("", "customerName"));
    ...
    public static class Factory {
         ...
         */
        public static CustomerValidateResponseE parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CustomerValidateResponseE object = new CustomerValidateResponseE();
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CustomerValidateResponse".equals(type)) {
                            ...
                            return (CustomerValidateResponseE) com.sysway.outwardtps.service.pay.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
