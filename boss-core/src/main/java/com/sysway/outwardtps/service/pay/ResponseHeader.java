...
public class ResponseHeader implements org.apache.axis2.databinding.ADBBean {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localResultDescTracker) {
            elementList.add(new javax.xml.namespace.QName("", "resultDesc"));
    ...
    public static class Factory {
         ...
         */
        public static ResponseHeader parse(
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ResponseHeader".equals(type)) {
                            ...
                            return (ResponseHeader) com.sysway.outwardtps.service.pay.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "resultDesc").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "resultDesc" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setResultDesc(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
