...
/**
 *  RechargeRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RechargeRequest implements org.apache.axis2.databinding.ADBBean {
    ...
    public void setBusinessID(java.lang.String param) {
        localBusinessIDTracker = param != null;
    ...
    public void serialize(final javax.xml.namespace.QName parentQName,
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":RechargeRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
        ...
        if (localTransactionTimeTracker) {
            ...
            if (localTransactionTime == null) {
                // write the nil attribute
                throw new org.apache.axis2.databinding.ADBException(
                    "transactionTime cannot be null!!");
            } else {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localBusinessIDTracker) {
            elementList.add(new javax.xml.namespace.QName("", "businessID"));
        ...
        if (localCustomerIDTracker) {
            elementList.add(new javax.xml.namespace.QName("", "customerID"));
        ...
        if (localTransactionTimeTracker) {
            elementList.add(new javax.xml.namespace.QName("", "transactionTime"));
    ...
    public static class Factory {
         ...
         */
        public static RechargeRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RechargeRequest object = new RechargeRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RechargeRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (RechargeRequest) com.sysway.outwardtps.service.pay.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "businessID").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "businessID" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setBusinessID(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "transactionTime").equals(
                            reader.getName())) {
                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance",
                            "nil");
                    ...
                    if ("true".equals(nillableValue) ||
                            "1".equals(nillableValue)) {
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "transactionTime" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setTransactionTime(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
