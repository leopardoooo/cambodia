/**
 * ReplyManuallyInfluencedWorkOrder.java
 *
...
/**
 *  ReplyManuallyInfluencedWorkOrder bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class ReplyManuallyInfluencedWorkOrder implements org.apache.axis2.databinding.ADBBean {
    /* This type was generated from the piece of schema that had
       name = replyManuallyInfluencedWorkOrder
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":replyManuallyInfluencedWorkOrder",
                    xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "replyManuallyInfluencedWorkOrder", xmlWriter);
            }
        }
    ...
    public static class Factory {
         ...
         */
        public static ReplyManuallyInfluencedWorkOrder parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            ReplyManuallyInfluencedWorkOrder object = new ReplyManuallyInfluencedWorkOrder();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"replyManuallyInfluencedWorkOrder".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (ReplyManuallyInfluencedWorkOrder) com.sysway.outwardtps.service.cfocn.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                    ...
                    object.setArg2(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
