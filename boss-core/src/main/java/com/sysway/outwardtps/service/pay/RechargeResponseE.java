...
/**
 *  RechargeResponseE bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class RechargeResponseE implements org.apache.axis2.databinding.ADBBean {
    ...
    public javax.xml.stream.XMLStreamReader getPullParser(
        ...
        if (localAccountBalanceTracker) {
            elementList.add(new javax.xml.namespace.QName("", "accountBalance"));
    ...
    public static class Factory {
         ...
         */
        public static RechargeResponseE parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            RechargeResponseE object = new RechargeResponseE();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"RechargeResponse".equals(type)) {
                            ...
                            return (RechargeResponseE) com.sysway.outwardtps.service.pay.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("", "accountBalance").equals(
                            reader.getName())) {
                    ...
                    if ("true".equals(nillableValue) ||
                        ...
                        throw new org.apache.axis2.databinding.ADBException(
                            "The element: " + "accountBalance" +
                            "  cannot be null");
                    }

                    java.lang.String content = reader.getElementText();

                    object.setAccountBalance(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(
                            content));
