...
/**
 *  CustomerValidateRequest bean class
 */
@SuppressWarnings({"unchecked",
    "unused"
})
public class CustomerValidateRequest implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":CustomerValidateRequest", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
    ...
    public static class Factory {
         ...
         */
        public static CustomerValidateRequest parse(
            javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception {
            CustomerValidateRequest object = new CustomerValidateRequest();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"CustomerValidateRequest".equals(type)) {
                            //find namespace for the prefix
                            java.lang.String nsUri = reader.getNamespaceContext()
                                                           .getNamespaceURI(nsPrefix);

                            return (CustomerValidateRequest) com.sysway.outwardtps.service.pay.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
