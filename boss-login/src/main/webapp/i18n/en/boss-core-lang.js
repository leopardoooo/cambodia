...
BCLang.common = {
	...
	remark: 'Remark~',
	remark2: 'Remark Information~',
	busiInfo: 'Business Information~',
	busiSave: 'Business Saved~',
	...
	plsSwitch: 'please select~',
	taskTitle: 'work order~',
	assignWay: 'Order Arrangement Method~',
	removeSelected: 'move the selected~',
...
BCLang.home = {
	...
	main: {
		...
		doc: {
			invoice: {
				_title: 'Invoice~',
				columns: ["Invoice No.~","Invoice Code~","Money Amount~","Print Time~"," Reception Issuance Way~","Invoice Type~","Usage Status~","Balance Status~","Operator~","Fee Generation Time~"]
			},
			task: {
				_title: 'Work Order~',
				columns: ["Work Order Type~"," Work Order Status~","Appointment Time~","Completion Time~","Creation Time~"]
			},
			busi: {
				_title: 'Service Reception Order~',
				columns: ["Operator~"," Final Print~","Service Name~"]
			},
			_form: {
				oldInvoiceId: 'Former Invoice No.~',
				oldInvoiceCode: ' Former Invoice Code~',
	...
	tools: {
		...
		invoiceQuery:{//Invoice Inquiry
			...
			labelMoneyAmount2:'Am&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ount~',
			labelUserOptrName:'Op&nbsp;era&nbsp;tor&nbsp;~',
			labelOptrName:'Ta&nbsp;ke&nbsp;r&nbsp;~',
