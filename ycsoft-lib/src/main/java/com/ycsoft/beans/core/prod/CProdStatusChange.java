...
public class CProdStatusChange extends PropertyChange implements Serializable {
	 ...
	 */
	public CProdStatusChange() {
	}

	public CProdStatusChange(String column_name, String old_value,
			String new_value) {
